$(function(){
	$(document).ready(function(){
		...
		var to_top="<div style='position: fixed; bottom: 50px; right: 30px; cursor: pointer; z-index: 999999; display: block; opacity: 0.8;'>"
		...
		var to_wechat="<div style='position: fixed; bottom: 150px; right: 30px; cursor: pointer; z-index: 999999; display: block; opacity: 0.8;'>"
